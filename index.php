...
<body>
    ...
    <footer>
        ...
        <div class="burbujas">
            ...
            <a href="https://api.whatsapp.com/send/?phone=+6181204849&text=Hola+que+tal+necesito+ayuda&app_absent=0" target="_blank"><img class="burbuja-whatsapp" src="img/whatsapp.jpeg" alt=""></a>

            <!-- Utilizar para PC, laptop Web.whatsapp-->
            <a href="https://web.whatsapp.com/send?phone=+6181204849&text=¡Buen dia ...!" target="_blank"><img class="burbuja-whatsapp" src="img/whatsapp.jpeg" alt=""></a>
    ...
    <script>
        $(function() {
            $('#WAButton').floatingWhatsApp({
                phone: '6181204849', //Número de telefono (Con prefijo 521 para México)
